<div class="modal fade" id="viewing_menu" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="exampleModalLabel">Viewing Menu</h4>
...
<div class="info-box-content">
<a href="view_stocks_unit.php"><span class="info-box-text"><b>View Unit Price</b></span></a>
